...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 222323;  // your prefix
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "db8b488aa900a003000021011661a1174158800194c3f36ac66194c3f36ac6db8b488aa9699efdb8b488aa9b5";
...
const char     CRYPTONOTE_NAME[]                             = "MyCoin";
...
const int      P2P_DEFAULT_PORT                              =  28841;
const int      RPC_DEFAULT_PORT                              =  28842;
const int      SERVICE_DEFAULT_PORT                          =  28843;
...
const char     LATEST_VERSION_URL[]                          = "https://github.com/mycoin/mycoin/releases";
const std::string LICENSE_URL                                = "https://github.com/mycoin/mycoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x3a, 0x1c, 0x2f, 0x1c, 0x2f, 0x52, 0x9c, 0xb4, 0x36, 0xfa, 0x9c, 0xb4, 0x36, 0xa1, 0x23, 0xae  }
};

const char* const SEED_NODES[] = {
  "1.1.1.1:28841", // Europe
};
} // CryptoNote
